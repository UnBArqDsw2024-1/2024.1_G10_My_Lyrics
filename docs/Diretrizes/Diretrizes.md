...
- rastro claro aos membros participantes (MOSTRAR QUADRO DE PARTICIPAÇÕES& COMMITS);
- justificativas & senso crítico sobre o trabalho realizado;
- breve apresentação de 1 técnica de elicitação e de 1 artefato elaborado
- comentários gerais sobre o trabalho em equipe. Tempo da Apresentação: +/- 10min.
...
Apresentação (em sala) explicando o detalhamento metodológico desenhado, com:
- rastro claro aos membros participantes (MOSTRAR QUADRO DE PARTICIPAÇÕES & COMMITS);
- justificativas & senso crítico sobre as escolhas metodológicas adotadas para o projeto;
- breve apresentação da modelagem em BPMN
- comentários gerais sobre o trabalho em equipe. Tempo da Apresentação: +/- 5min.
